...
#       x.2 = RBD[which(cluster.ew==2), i]
    ...
    # Instead comparing HC and Parkinson: 
    # p-values: 0.003 0.000 0.034 0.205 0.265 0.832 0.002 0.001 0.043 0.010 0.103 0.079
    # the variables in whic i observe the difference are the following: Rate of speech timing, Duration of pause intervals,
    # Duration of pause intervals and all the variables about the monologue except Pause intervals per respiration.1 .
      
       cormat <- cor(dataset[,c(20,23,24)])
       library(corrplot)
       x11()
